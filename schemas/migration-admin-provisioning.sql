...
BEGIN
  ...
  INSERT INTO public.system_logs (clinic_id, workflow_name, log_level, message, details)
  VALUES (
    p_clinic_id,
    'admin-console',
    'INFO',
...
-- -----------------------------------------------------------------------------
-- Fix: auto-populate clinic_id on child rows (prevents NOT NULL failures on
-- prescription_medicines when legacy/demo inserts omit clinic_id)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- Fix: demo seed must set clinic_id on prescription_medicines (multitenant NOT NULL)
-- Re-declare only the INSERT block via full function replace from admin console.
-- -----------------------------------------------------------------------------
